...
def add_server():
    ...
    for i in range(0, n):
        ...
        if (i < len(hostnames)):
            ...
            with server_name_to_dbname_lock:
                server_name_to_dbname[validname]=dbname  #Associating the db with the new server name
...
def remove_server():
    ...
    for i in range(0, n):
        ...
        with server_name_to_dbname_lock:
            dbname=server_name_to_dbname[validname] #Get the name of the database associated with the server
        ...
        with server_name_to_dbname_lock:
            del server_name_to_dbname[validname]
